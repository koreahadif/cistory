...
nhn.FindReplace = jindo.$Class({
	...
	replaceAll : function(sOriginalWord, Replacement, bCaseMatch, bWholeWord){
		...
		// �쒖옉�먯쓽 遺곷쭏�ш� 吏�썙吏�㈃���쒖옉�먯쓣 吏�굹��replace媛��섎뒗 �꾩긽 諛⑹���
		// 泥��⑥뼱 �욎そ���뱀닔 臾몄옄 �쎌엯 �댁꽌, replace���④퍡 遺곷쭏�ш� �щ씪吏�뒗 寃�諛⑹�
		...
		// setTimeout �놁씠 諛붾줈 吏�슦硫�IE8 釉뚮씪�곗�媛�鍮덈쾲�섍쾶 二쎌뼱踰꾨┝
		setTimeout(function(){
...
nhn.HuskyRange = jindo.$Class({
	...
	*/
	 ...
	 * @param {Object} 	oStyle 					�곸슜���ㅽ��쇱쓣 媛����Object (�� 湲�섦 ���곸슜��寃쎌슦 { color : "#0075c8" }
	 * @param {Object} 	[oAttribute] 			�곸슜���띿꽦��媛����Object (�� 留욎땄踰�寃�궗��寃쎌슦 { _sm2_spchk: "媛뺣궓肄�, class: "se2_check_spell" }
	 * @param {String} 	[sNewSpanMarker] 		�덈줈 異붽���SPAN �몃뱶瑜��섏쨷���곕줈 泥섎━�댁빞�섎뒗 寃쎌슦 留덊궧���꾪빐 �ъ슜�섎뒗 臾몄옄��
	 * @param {Boolean} [bIncludeLI] 			LI ���ㅽ����곸슜���ы븿��寃껋씤吏�쓽 �щ� [COM-1051] _getStyleParentNodes 硫붿꽌��李멸퀬�섍린
	...
	styleRange : function(oStyle, oAttribute, sNewSpanMarker, bIncludeLI, bCheckTextDecoration){
		...
		for(var i=0; i<aStyleParents.length; i++){
			for(var x in oStyle){
				...
				// [SMARTEDITORSUS-26] 湲�섦 �됱쓣 �곸슜����痍⑥냼��諛묒쨪���됱긽��泥섎━�섎룄濡�異붽�
	 ...
	 * @param {Boolean}	[bIncludeLI]		LI ���ㅽ����곸슜���ы븿��寃껋씤吏�쓽 �щ�
	...
	_getStyleParentNodes : function(sNewSpanMarker, bIncludeLI){
		...
		// [COM-1051] 蹂몃Ц�댁슜����以꾨쭔 �낅젰�섍퀬 踰덊샇 留ㅺ릿 �곹깭�먯꽌 湲�옄�ш린瑜�蹂�꼍�섎㈃ 踰덊샇�ш린��蹂�븯吏��딅뒗 臾몄젣
		// 遺�え �몃뱶 以�LI 媛��덇퀬, �대떦 LI ��紐⑤뱺 �먯떇 �몃뱶媛��좏깮���곹깭�쇰㈃ LI�먮룄 �ㅽ��쇱쓣 �곸슜�섎룄濡�泥섎━��
		...
		for(var i=0; i<nInitialLength; i++){
			...
			// 遺�え �몃뱶媛�SPAN ��寃쎌슦�먮뒗 �덈줈��SPAN ���앹꽦�섏� �딄퀬 SPAN ��由ы꽩 諛곗뿴��異붽���
...
nhn.BrowserSelection = function(win){
	...
	// [SMARTEDITORSUS-888] IE9 �댄썑濡�document.createRange 瑜�吏�썝
/*	var oAgentInfo = jindo.$Agent().navigator();
	if(oAgentInfo.ie){
...
nhn.husky.SE2M_Toolbar = jindo.$Class({
	...
	$init : function(oAppContainer){
		...
		this._setRoundedCornerButton();	// [SMARTEDITORSUS-1124] �띿뒪���대컮 踰꾪듉���쇱슫��泥섎━
	},
...
*/
		...
		//�뱀젒洹쇱꽦 
		//���④퀎�먯꽌 oAppContainer媛��뺤쓽�섏� �딆� �곹깭�쇱꽌 this.toolbarArea蹂�닔媛믪쓣 �ъ슜�섏� 紐삵븯怨��꾨옒��媛숈씠 �ㅼ떆 �뺤쓽�섏���
	...
	//�ъ빱�ㅺ� �대컮���덈뒗 �곹깭�먯꽌 �⑥텞�ㅻ� �꾨Ⅴ硫��먮뵒���곸뿭�쇰줈 �ㅼ떆 �ъ빱�ㅺ� 媛�룄濡��섎뒗 �⑥닔. (�뱀젒洹쇱꽦)  
...
//		jindo.$Element(this.toolbarArea).addClass("off");
	...
	_getAffectedElements : function(el){
		...
		// 踰꾪듉 �대┃�쒖뿉 return false瑜���二쇱� �딆쑝硫�chrome�먯꽌 踰꾪듉���ъ빱��媛�졇媛�踰꾨┝.
		...
		if((elLi = el).tagName == "SPAN"){
			...
			// <LI>
			//     <SPAN>
			//湲�컧怨�湲�뼇��			if((elLi = elLi.parentNode) && elLi.tagName == "LI" && this.rxUI.test(elLi.className)){
				return [jindo.$Element(elLi)];
			}
		}
	...
	/*
	 * �띿뒪���대컮��踰꾪듉 �쇱슫��泥섎━
	 * [MOSS] "[UI媛쒕컻1�� �ㅻ쭏�몄뿉�뷀꽣 �띿뒪�명댋諛붾쾭���쇱슫�⑹쿂由ш��대뱶" 李멸퀬
	 *		- 踰꾪듉 �쇱슫��泥섎━瑜��꾪븳 tool_bg �대옒��異붽�瑜��꾪븳 �섎━癒쇳듃 �먯깋��_buttonRound �대옒���ъ슜 (AU 異붽��대옒��
	 */
	_setRoundedCornerButton : function(){
		...
		// 踰꾪듉 醫뚯륫 �쇱슫��泥섎━
		// ��二쇱쓽: �붾낫湲��섏쐞��踰꾪듉 �쇱슫��泥섎━��寃쎌슦���덉쑝誘�줈 諛붾줈 �섏쐞 UL���꾨땶 寃쎌슦���덉쓬
	...
	$ON_REGISTER_UI_EVENT : function(sUIName, sEvent, sCmd, aParams){
		...
		//						而ㅼ꽌 二쇱쐞��<sub><sup> �쒓렇媛�遺숈뼱��湲�옄媛�留ㅼ슦 �묎쾶 �섎뒗 �꾩긽
		//�먯씤 : �꾨옒��[SMARTEDITORSUS-901] �섏젙 �댁슜�먯꽌 �쀬꺼���꾨옯泥⑥옄 �대깽���깅줉 ��
		//�대떦 �뚮윭洹몄씤��留덊겕�낆뿉 �놁쑝硫�this.htUIList��議댁옱�섏� �딆븘 getsingle �ъ슜���ъ쭊泥⑤����대깽�멸� 嫄몃졇��		//�닿껐 : this.htUIList��議댁옱�섏� �딆쑝硫��대깽�몃� �깅줉�섏� �딆쓬
		...
		//�닿껐 : firstchild���대깽�몃� 嫄곕뒗 寃껋씠 �꾨땲�� child 以�button ��寃껋뿉 �대깽�몃� 嫄몃룄濡�蹂�꼍
...
nhn.husky.SE2M_EditingModeChanger = jindo.$Class({
	...
	_assignHTMLElements : function(elAppContainer, htConversionMode){
		...
		// [SMARTEDITORSUS-906] Editing Mode �ъ슜 �щ� 泥섎━ (true:�ъ슜�� false:�ъ슜�섏� �딆쓬)
 ...
 * LOAD_CONTENTS_FIELD
 *
 * �먮뵒��珥덇린���쒖뿉 �섏뼱��Contents(DB ��옣 媛��꾨뱶瑜��쎌뼱 �먮뵒�곗뿉 �ㅼ젙�쒕떎.
 *
 ...
 * RESIZE_EDITING_AREA
 *
 * �몄쭛 �곸뿭 �ъ씠利덈� �ㅼ젙 �쒕떎. 蹂�꼍 �꾪썑��MSG_EDITIING_AREA_RESIZE_STARTED/MSG_EDITING_AREA_RESIZE_ENED瑜�諛쒖깮 �쒖폒 以섏빞 �쒕떎.
 *
 * ipNewWidth number ����
 ...
 *
 * �몄쭛 �곸뿭 �ъ씠利덈� �섎━嫄곕굹 以꾩씤�� 蹂�꼍 �꾪썑��MSG_EDITIING_AREA_RESIZE_STARTED/MSG_EDITING_AREA_RESIZE_ENED瑜�諛쒖깮 �쒖폒 以섏빞 �쒕떎.
 * 蹂�꼍移섎� �낅젰�섎㈃ �먮옒 �ъ씠利덉뿉��蹂�꼍�섏뿬 px濡��곸슜�섎ŉ, width媛�%濡��ㅼ젙��寃쎌슦�먮뒗 ��蹂�꼍移섍� �낅젰�섏뼱���곸슜�섏� �딅뒗��
 *
 * ipWidthChange number ��蹂�꼍移�
 * ipHeightChange number �믪씠 蹂�꼍移�
 *
---------------------------------------------------------------------------]*/
/*[
...
---------------------------------------------------------------------------]*/
/**
 * @pluginDesc IR 媛믨낵 蹂듭닔媛쒖쓽 �몄쭛 �곸뿭��愿�━�섎뒗 �뚮윭洹몄씤
 */
nhn.husky.SE_EditingAreaManager = jindo.$Class({
	...
	$ON_MSG_APP_READY : function(){
		...
		//[SMARTEDITORSUS-1327] IE 7/8�먯꽌 ALT+0�쇰줈 �앹뾽 �꾩슦怨�esc�대┃���앹뾽李��ロ엳寃��섎젮硫��꾨옒 遺�텇 瑗��꾩슂�� 
	...
	// �먮뵒�곗쓽 �꾩옱 �곹깭瑜�湲곗뼲���� �섏씠吏�� �좊궇 ����媛믪씠 蹂�꼍 �먮뒗吏��뺤씤 �댁꽌 �댁슜��蹂�꼍 �먮떎��寃쎄퀬李쎌쓣 �꾩�
	// RawContents ��떊 contents瑜��댁슜�대룄 �섏�留� contents �띾뱷���꾪빐�쒕뒗 蹂�솚湲곕� �ㅽ뻾�댁빞 �섍린 �뚮Ц��RawContents �댁슜
	...
	$AFTER_CHANGE_EDITING_MODE : function(sMode, bNoFocus){
		...
		this.startAutoResize();	// [SMARTEDITORSUS-677] 蹂�꼍���몄쭛 紐⑤뱶�먯꽌���먮룞�뺤옣���쒖옉
	...
	$ON_FOCUS : function(){
		...
		// [SMARTEDITORSUS-599] ipad ��쓳 �댁뒋.
		// ios5�먯꽌��this.iframe.contentWindow focus媛��놁뼱���앷릿 �댁뒋. 
		// document媛��꾨땶 window��focus() 二쇱뼱�쇰쭔 蹂몃Ц��focus媛�媛�퀬 �낅젰�대맖.
		
		//[SMARTEDITORSUS-1017] [iOS5��쓳] 紐⑤뱶 �꾪솚 ��textarea���ъ빱�ㅺ� �덉뼱��湲�옄媛��낅젰���덈릺���꾩긽
		//�먯씤 : WYSIWYG紐⑤뱶媛��꾨땺 �뚯뿉��iframe��contentWindow��focus媛�媛�㈃��focus湲곕뒫���묐룞�섏� �딆쓬
	...
	$ON_MSG_EDITING_AREA_RESIZE_STARTED : function(){
		...
		this.oApp.exec("STOP_AUTORESIZE_EDITING_AREA");	// [SMARTEDITORSUS-677] �ъ슜�먭� �몄쭛�곸뿭 �ъ씠利덈� 蹂�꼍�섎㈃ �먮룞�뺤옣 湲곕뒫 以묒�
...
nhn.husky.SE_EditingAreaVerticalResizer = jindo.$Class({
	...
	$ON_MSG_APP_READY : function(){
		...
		//[SMARTEDITORSUS-941][iOS5��쓳]�꾩씠�⑤뱶���먮룞 �뺤옣 湲곕뒫���숈옉�섏� �딆쓣 ���먮뵒��李쎈낫��湲��댁슜���묒꽦�섎㈃ �먮뵒�곕� �リ퀬 �섏삤���꾩긽 
		//�먯씤 : �먮룞�뺤옣 湲곕뒫���뺤� ��寃쎌슦 iframe���ㅽ겕濡ㅼ씠 �앷린吏��딄퀬, 李쎌쓣 �リ퀬 �섏샂
		//�닿껐 : ��긽 �먮룞�뺤옣 湲곕뒫��耳쒖졇�덈룄濡�蹂�꼍. �먮룞 �뺤옣 湲곕뒫 愿�젴���대깽��肄붾뱶��紐⑤컮���ы뙆由ъ뿉���덉쇅 泥섎━
		if(jindo.$Agent().navigator().msafari){
			jindo.$Element(this.oResizeGrip).first().text('�낅젰李��믪씠 �먮룞 議곗젙 諛�');
		...
		if(!!this.oApp.getEditingAreaHeight){
			this.nEditingAreaMinHeight = this.oApp.getEditingAreaHeight();	// [SMARTEDITORSUS-677] �몄쭛 �곸뿭��理쒖냼 �믪씠瑜�媛�졇��Gap 泥섎━ ���ъ슜
		}
	},
	...
	checkResizeGripPosition : function(bExpand){
		...
		if(bExpand){
			if(this.nEditingAreaMinHeight > this.oApp.getEditingAreaHeight() - nGap){	// [SMARTEDITORSUS-822] �섏젙 紐⑤뱶��寃쎌슦����퉬
				nGap = (-1) * (this.nEditingAreaMinHeight - this.oApp.getEditingAreaHeight());
			}
	
			// Gap 留뚰겮 �몄쭛�곸뿭 �ъ씠利덈� 議곗젅�섏뿬
			// �ъ쭊 泥⑤���遺숈뿬�ｊ린 �깆쓽 �ъ씠利덇� ���댁슜 異붽�媛��덉뿀�����낅젰李��ш린 議곗젅 諛붽� �④꺼吏�� �딅룄濡���
	...
	_assignHTMLElements : function(elAppContainer, htConversionMode){
		...
		// [SMARTEDITORSUS-906] Resizbar �ъ슜 �щ� 泥섎━ (true:�ъ슜�� false:�ъ슜�섏� �딆쓬)
...
nhn.husky.SE_EditingArea_HTMLSrc = jindo.$Class({
	...
	$ON_MSG_APP_READY : function() {
		if(!!this.oApp.getEditingAreaHeight){
			this.nMinHeight = this.oApp.getEditingAreaHeight();	// [SMARTEDITORSUS-677] �몄쭛 �곸뿭��理쒖냼 �믪씠瑜�媛�졇���먮룞 �뺤옣 泥섎━瑜������ъ슜
		}
	},
...
nhn.husky.SE_EditingArea_TEXT = jindo.$Class({
	...
	irToText : function(sHtml) {
		...
		//0.�덈낫�대뒗 媛믩뱾����븳 �뺣━. (�먮뵒��紐⑤뱶��view��text紐⑤뱶��view瑜��숈씪�섍쾶 �댁＜湲��꾪빐��		
		sContent = sContent.replace(/\r/g, '');// MS�묒� �뚯씠釉붿뿉��tr蹂꾨줈 遺꾨━�댁＜����븷��r�닿린 �뚮Ц�� text紐⑤뱶濡�蹂�꼍�쒖뿉 媛�룆�깆쓣 �꾪빐 \r �쒓굅�섎뒗 寃껋� �꾩떆 蹂대쪟. - 11.01.28 by cielo 
	...
	/**
	 * HTML �쒓렇���대떦�섎뒗 湲�옄媛�癒뱁엳吏��딅룄濡�諛붽퓭二쇨린
	 *
	 * �숈옉) & 瑜�&amp; 濡� < 瑜�&lt; 濡� > 瑜�&gt; 濡�諛붽퓭以�떎
	 *
	 * @param {String} sText
	 * @return {String}
	 */
	 ...
	 *
	 * �숈옉) &amp, &lt, &gt, &nbsp 瑜�媛곴컖 &, <, >, 鍮덉뭏�쇰줈 諛붽퓭以�떎
	 *
	 * @param {String} sText
	 * @return {String}
	 */
 ...
 * 二쇱쓽] REFRESH_WYSIWYG�꾩뿉��蹂몃Ц��selection��源⑥졇��而ㅼ꽌 �쒖씪 �욎쑝濡�媛�뒗 �꾩긽���덉쓬. (stringbookmark濡�泥섎━�댁빞��)
 *  
 * none
 *
---------------------------------------------------------------------------]*/
...
//	iMinUndoInterval : 50,
	...
	$init : function(iframe){
		...
		// IE�먯꽌 �먮뵒��珥덇린���쒖뿉 �꾩쓽�곸쑝濡�iframe���ъ빱�ㅻ� 諛섏�(IME �낅젰 �덈릺怨�而ㅼ꽌留�源쒕컯�대뒗 �곹깭) 二쇰뒗 �꾩긽��留됯린 �꾪빐���쇰떒 iframe���④꺼 ��떎媛�CHANGE_EDITING_MODE�먯꽌 �꾩����꾪솚 ��蹂댁뿬以�떎.
		// �대윴 �꾩긽���ㅼ뼇���붿냼���섑빐��諛쒖깮�섎ŉ 諛쒓껄��紐뉕�吏�寃쎌슦��
		// - frameset�쇰줈 �섏씠吏�� 援ъ꽦���꾩뿉 �쒓컻��frame�덉뿉 踰꾪듉���먯뼱 �먮뵒�곕줈 留곹겕 ��寃쎌슦
		// - iframe怨��숈씪 �섏씠吏�뿉 議댁옱�섎뒗 text field��媛믪쓣 �좊떦 ��寃쎌슦
		if(oAgent.ie){
			this.iframe.style.display = "none";
		}
	
		// IE8 : 李얘린/諛붽씀湲곗뿉��湲�옄 �쇰����ㅽ��쇱씠 �곸슜��寃쎌슦 李얘린媛��덈릺��釉뚮씪�곗� 踰꾧렇濡��명빐 EmulateIE7 �뚯씪���ъ슜
	...
	$ON_MSG_APP_READY : function(){
		...
		// DTD媛�quirks媛��꾨땺 寃쎌슦 body �믪씠 100%媛��쒕�濡��숈옉�섏� �딆븘����엫�꾩썐���뚮ŉ �믪씠瑜��섎룞�쇰줈 怨꾩냽 �좊떦 ��以�
	...
	/**
	 * [SMARTEDITORSUS-677] 遺숈뿬�ｊ린���댁슜 �낅젰����븳 �몄쭛�곸뿭 �먮룞 �뺤옣 泥섎━
	 */ 
	...
	startAutoResize : function(){
		...
		// [SMARTEDITORSUS-887] [釉붾줈洹�1�� �먮룞�뺤옣 紐⑤뱶�먯꽌 �먮뵒��媛�줈�ъ씠利덈낫�����ъ쭊��異붽��덉쓣 ��媛�줈�ㅽ겕濡ㅼ씠 �덉깮湲곕뒗 臾몄젣
		if(oBrowser.ie && oBrowser.version < 9){
			jindo.$Element(this.getDocument().body).css({ "overflow" : "visible" });

			// { "overflowX" : "visible", "overflowY" : "hidden" } �쇰줈 �ㅼ젙�섎㈃ �몃줈 �ㅽ겕濡�肉��꾨땲��媛�줈 �ㅽ겕濡ㅻ룄 蹂댁씠吏��딅뒗 臾몄젣媛��덉뼱
			// { "overflow" : "visible" } 濡�泥섎━�섍퀬 �먮뵒�곗쓽 container �ъ씠利덈� �섎젮 �몃줈 �ㅽ겕濡ㅼ씠 蹂댁씠吏��딅룄濡�泥섎━�댁빞 ��
			// [�쒓퀎] �먮룞 �뺤옣 紐⑤뱶�먯꽌 �댁슜���섏뼱�����몃줈 �ㅽ겕濡ㅼ씠 蹂댁��ㅺ� �놁뼱吏�뒗 臾몄젣
		}else{
	...
	/**
	 * [SMARTEDITORSUS-677] �몄쭛 �곸뿭 Body媛�蹂�꼍�섏뿀�붿� 二쇨린�곸쑝濡��뺤씤
	 */ 
	...
	_setAutoResize : function(){		
		...
		if((oBrowser.ie && oBrowser.nativeVersion >= 9) || oBrowser.chrome){	// �댁슜��以꾩뼱��scrollHeight媛�以꾩뼱�ㅼ� �딆쓬
		...
		if(oBrowser.ie){
			...
			// �댁슜 媛�옣 �ㅼ뿉��Enter瑜��섎뒗 寃쎌슦 �꾨옒�꾨줈 �붾뱾��蹂댁씠��臾몄젣媛�諛쒖깮
			if(nBodyHeight > this.nBodyMinHeight){
		...
		// }else if(oBrowser.safari){	// -- �ы뙆由ъ뿉���댁슜��以꾩뼱�ㅼ� �딅뒗 臾몄젣媛��덉뼱 Firefox 諛⑹떇�쇰줈 蹂�꼍��
			...
			// [FF] nContainerHeight瑜�異붽�濡��뷀븯��쓬. setTimeout ��臾댄븳 利앹떇�섎뒗 臾몄젣媛�諛쒖깮�����덉쓬
			if(nBodyHeight > this.nBodyMinHeight){
				oCurrentStyle = this.oApp.getCurrentStyle();
				nStyleSize = parseInt(oCurrentStyle.fontSize, 10) * oCurrentStyle.lineHeight;
		...
		this.iframe.style.height = nContainerHeight + "px";				// �몄쭛�곸뿭 IFRAME���믪씠 蹂�꼍
		this.oApp.welEditingAreaContainer.height(nContainerHeight);		// �몄쭛�곸뿭 IFRAME��媛먯떥��DIV �믪씠 蹂�꼍
	...
	_setBodyHeight : function(){
		if( this.bStopCheckingBodyHeight ){ // 硫덉떠���섎뒗 寃쎌슦 true, 怨꾩냽 泥댄겕�댁빞 �섎㈃ false
			// �꾩���紐⑤뱶�먯꽌 �ㅻⅨ 紐⑤뱶濡�蹂�꼍����"document��css瑜��ъ슜 �좎닔 �놁뒿�덈떎." �쇰뒗 error 媛�諛쒖깮.
			// 洹몃옒��on_change_mode�먯꽌 bStopCheckingBodyHeight 瑜�true濡�蹂�꼍�쒖폒以섏빞 ��
			return;
		}
	...
	$ON_IE_CHECK_EXCEPTION_FOR_SELECTION_PRESERVATION : function(){
		// �꾩옱 �좏깮���⑤━癒쇳듃媛�iframe�대씪硫� ��젆�섏쓣 �곕줈 湲곗뼲 ���먯� �딆븘���좎� �⑥쑝濡�RESTORE_IE_SELECTION����� �딅룄濡�this._oIERange��吏�썙以�떎.
		// (�꾩슂 �놁쓣 肉먮뜑����옣 ��臾몄젣 諛쒖깮)
		...
		/* // [SMARTEDITORSUS-978] HuskyRange.js ��[SMARTEDITORSUS-888] �댁뒋 �섏젙怨�愿�젴
	...
	$ON_EVENT_EDITING_AREA_KEYDOWN : function(oEvent){
		...
		this._recordUndo(oKeyInfo);	// 泥ル쾲吏�Delete ���낅젰 �꾩쓽 �곹깭媛���옣�섎룄濡�KEYDOWN �쒖젏����옣
	},
	...
	$ON_PASTE_HTML : function(sHTML, oPSelection, bNoUndo){
		...
		//[SMARTEDITORSUS-888] 釉뚮씪�곗� 蹂��뚯뒪�����꾨옒 遺�텇��遺덊븘�뷀븯���쒓굅��
		...
		if(!oNavigator.ie){
			...
			//�대�吏��섎굹 �쎌엯 ���대�吏�뿉 �ъ빱�깆씠 �볦씠吏��딆뒿�덈떎.
			//�먯씤 : parameter濡��섍꺼 諛쏆� oPSelecion��蹂�꼍��媛믪쓣 蹂듭궗��二쇱� �딆븘��諛쒖깮
			//�닿껐 : parameter濡��섍꺼 諛쏆� oPSelecion��蹂�꼍��媛믪쓣 蹂듭궗�댁���
			//       call by reference濡��섍꺼 諛쏆븯�쇰�濡�吏곸젒 媛앹껜 �덉쓽 �몄옄 媛믪쓣 諛붽퓭二쇰뒗 setRange �⑥닔 �ъ슜
			if(!!oPSelection){
				oPSelection.setRange(oSelection);
			}
		}else{
			// [SMARTEDITORSUS-428] [IE9.0] IE9�먯꽌 �ъ뒪���곌린���묎렐�섏뿬 留⑥쐞���꾩쓽��湲�컧 泥⑤� ���뷀꽣瑜��대┃ ��湲�컧���щ씪吏�
			// PASTE_HTML �꾩뿉 IFRAME 遺�텇���좏깮���곹깭�ъ꽌 Enter ���댁슜���쒓굅�섏뼱 諛쒖깮��臾몄젣
			oSelection.collapseToEnd();
			oSelection.select();
	...
	/**
	 * [SMARTEDITORSUS-344]�ъ쭊/�숈쁺��吏�룄 �곗냽泥⑤����ъ빱��媛쒖꽑�댁뒋濡�異붽����⑥닔.
	 */
	...
	/* 
	 * Window�먯꽌 �꾩옱 蹂댁뿬吏�뒗 �곸뿭��top, bottom 媛믪쓣 諛섑솚
	 */
	...
	/* 
	 * �섎━癒쇳듃媛�WYSIWYG Window��Visible 遺�텇�먯꽌 �꾩쟾��蹂댁씠���곹깭�몄� �뺤씤 (�쇰�留�蹂댁씠硫�false)
	 */
	...
	$BEFORE_MSG_EDITING_AREA_RESIZE_STARTED  : function(){
		// FF�먯꽌 Height議곗젙 �쒖뿉 蹂몃Ц��_fitElementInEditingArea()�⑥닔 遺�텇�먯꽌 selection��源⑥����꾩긽���↔린 �꾪빐��
		// StringBookmark瑜��ъ슜�댁꽌 �꾩튂瑜���옣�대몺. (step1)
		if(!jindo.$Agent().navigator().ie){
			var oSelection = null;
			oSelection = this.oApp.getSelection();
	...
	$AFTER_MSG_EDITING_AREA_RESIZE_ENDED : function(FnMouseDown, FnMouseMove, FnMouseUp){
		...
		// $BEFORE_MSG_EDITING_AREA_RESIZE_STARTED�먯꽌 ��옣��StringBookmark瑜��뗮똿�댁＜怨���젣��(step2)
		if(!jindo.$Agent().navigator().ie){
	...
	/**
	  ...
	  *		�꾩���紐⑤뱶�먯꽌 �먮뵒��蹂몃Ц��paste �대깽�몄뿉 ��븳 硫붿떆吏�� 泥섎━�쒕떎.
	  *		paste �쒖뿉 �댁슜��遺숈뿬吏�蹂몃Ц���댁슜��諛붾줈 媛�졇�����놁뼱 delay 瑜�以�떎.
	  */	
	...
	// [SMARTEDITORSUS-855] IE�먯꽌 �뱀젙 釉붾줈洹�湲�쓣 蹂듭궗�섏뿬 遺숈뿬�ｊ린 �덉쓣 ��媛쒗뻾���쒓굅�섎뒗 臾몄젣
...
nhn.husky.SE_WYSIWYGEnterKey = jindo.$Class({
	...
	$init : function(sLineBreaker){
		...
		/**
		 *	[SMARTEDITORSUS-230] 諛묒쨪+�됱긽蹂�꼍 �� �뷀꽣移섎㈃ �ㅽ겕由쏀듃 �ㅻ쪟
		 *	[SMARTEDITORSUS-180] [IE9] 諛곌꼍���곸슜 �� �뷀꽣��2�뚯씠���낅젰��而ㅼ꽌�꾩튂媛��ㅼ쓬 �쇱씤�쇰줈 �대룞�섏� �딆쓬
		 * 		�ㅻ쪟 �꾩긽 : 	IE9 �먯꽌 �뷀꽣 ���앹꽦��P �쒓렇媛�"鍮�SPAN �쒓렇留�媛����寃쎌슦" P �쒓렇 �곸뿭��蹂댁씠吏��딄굅���ъ빱�ㅺ� �꾨줈 �щ씪媛�蹂댁엫
		 *		�닿껐 諛⑸쾿 : 	而ㅼ꽌 ��뜑濡�IE �댁쇅�먯꽌��<br> ���ъ슜
		 *						- IE �먯꽌���뚮뜑留���<br> 遺�텇�먯꽌 鍮꾩젙�곸쟻��P �쒓렇媛��앹꽦�섏뼱 [SMARTEDITORSUS-230] �ㅻ쪟 諛쒖깮
		 *						unescape("%uFEFF") (BOM) ��異붽�
		 *						- IE9 �쒖�紐⑤뱶�먯꽌 [SMARTEDITORSUS-180] ��臾몄젣媛�諛쒖깮��
		 *						(unescape("%u2028") (Line separator) 瑜��ъ슜�섎㈃ P 媛�蹂댁뿬吏�굹 �ъ씠�쒖씠�숉듃媛��곕젮�섏뼱 �ъ슜�섏� �딆쓬)
	...
	/**
	 * [SMARTEDITORSUS-950] �먮뵒���곸슜 �섏씠吏�쓽 Compatible meta IE=edge �ㅼ젙 ��以꾧컙寃�踰뚯뼱吏��댁뒋 (<BR>)
	 */
	$ON_REGISTER_CONVERTERS : function(){
	 ...
	 *	: ��옣 ��蹂몃Ц �곸뿭�먯꽌 P �꾨옒��紐⑤뱺 �섏쐞 �쒓렇 以�媛�옣 留덉�留�childNode媛�BR��寃쎌슦瑜��먯깋�섏뿬 �대� &nbsp;濡�蹂�꼍��以띾땲��
	 */
	...
	// [IE] Selection �댁쓽 �몃뱶瑜�媛�졇��鍮��몃뱶��unescape("%uFEFF") (BOM) ��異붽�
	...
	_addExtraCursorHolder : function(elUpperNode){
		...
		this._addSpace(elParent.previousSibling);	// �곷떒 P �몃뱶��怨듬갚臾몄옄 異붽�
		this._addSpace(elParent);					// �섎떒 P �몃뱶��怨듬갚臾몄옄 異붽�
	...
	// [IE] P �쒓렇 媛�옣 ���먯떇�몃뱶濡�怨듬갚(&nbsp;)��媛믪쑝濡��섎뒗 �띿뒪���몃뱶瑜�異붽�
	...
	// [IE9 standard mode] _getStyleOnlyNode �먯꽌 �몃뱶瑜�寃�깋����鍮��몃뱶媛��덉쑝硫�BOM 異붽� 
...
nhn.husky.SE2M_Accessibility = jindo.$Class({
	...
	$ON_MSG_APP_READY : function(){
        ...
        if ((this.sType == 'basic' || this.sType == 'light') && (this.sLang != 'ko_KR'))  {
                ...
                //[SMARTEDITORSUS-1327] IE 7/8�먯꽌 ALT+0�쇰줈 �앹뾽 �꾩슦怨�esc�대┃���앹뾽李��ロ엳寃��섎젮硫��꾨옒 遺�텇 瑗��꾩슂�� (target��document媛��섏뼱����)
	...
	//SE2M_Configuration_General �먯꽌 吏�젙���먮뵒���곸뿭 �댄썑���섎젅癒쇳듃濡��ъ빱�ㅺ� �대룞�섎룄濡��쒕떎. 
	...
	//SE2M_Configuration_General�먯꽌 吏�젙���먮뵒���곸뿭 �댁쟾���섎젅癒쇳듃濡��ъ빱�ㅺ� �대룞�섎룄濡��쒕떎. 
	...
	$ON_FOCUS_TOOLBAR_AREA : function(){
		...
		//IE7�먯꽌��ALT+F10 �ㅽ뻾�덉쓣 ���ъ빱�ㅺ� �먮뵒���곸뿭�먮룄 媛�뒗 �꾩긽���앷린誘�줈 釉뚮씪�곗� 踰꾩쟾 泥댄겕�댁꽌 window.focus �ｌ뼱以�   
		if(jindo.$Agent().navigator().ie && jindo.$Agent().navigator().version == 7) {
            window.focus();
		}
	...
	$ON_OPEN_HELP_POPUP : function() {
        ...
        //[SMARTEDITORSUS-1327] IE�먯꽌 �ъ빱���댁뒋濡�IE����빐�쒕쭔 window.focus�ㅽ뻾�� 
        if(jindo.$Agent().navigator().ie) {
        	window.focus();
        }
 ...
 */
 nhn.husky.SE2M_ColorPalette = jindo.$Class({
	...
	rxColorPattern : /^#?[0-9a-fA-F]{6}$|^rgb\(\d+, ?\d+, ?\d+\)$/i,
	aRecentColor : [],	// 理쒓렐 �ъ슜����紐⑸줉, 媛�옣 理쒓렐���깅줉���됱쓽 index媛�媛�옣 �묒쓬
	URL_COLOR_LIST : "",
	URL_COLOR_ADD : "",
	URL_COLOR_UPDATE : "",
...
//		this.oApp.exec("REGISTER_UI_EVENT", ["styleRemover", "click", "EXECCOMMAND", ["RemoveFormat", false, false]]);
	...
	$BEFORE_EXECCOMMAND : function(sCommand, bUserInterface, vValue, htOptions){
		...
		if(sCommand.match(/^bold|underline|italic|strikethrough|superscript|subscript$/i)){
			...
			if( nhn.CurrentSelection.isCollapsed()){
				...
				//[SMARTEDITORSUS-228] 湲�섦 �④낵瑜�誘몃━ 吏�젙 ���꾩뿉 �띿뒪���낅젰 �� �됱긽 蹂�꼍���곸슜�섎굹 援듦쾶 湲곗슱��諛묒쨪 痍⑥냼���깆쓽 �④낵���곸슜�덈맖
				if( this.oNavigator.ie ){
	...
	// [SMARTEDITORSUS-851] align, text-align��fix�댁빞 ����긽 �몃뱶瑜�李얠쓬
	...
	_fixDocumentBR : function(){
		// [COM-715] ExecCommand媛�泥섎━���꾩뿉 �낅뜲�댄듃��BR��泥섎━ �꾩뿉 ��옣��BR怨�鍮꾧탳�섏뿬 �앹꽦��BR���쒓굅
	...
	_outdentMargin : function(elDiv){
		...
		if(elDiv.tagName === "LI"){
			...
			if(elDiv.previousSibling && elDiv.previousSibling.tagName && elDiv.previousSibling.tagName.match(/LI|UL|OL/)){
				...
				// �꾩옱 LI媛�留덉�留�LI�쇰㈃ 遺�え OL/UL �섎떒���쎌엯
				}else{
			...
			// �댁뼱�곌린 ��LI �몄뿉 �ㅻⅨ LI媛�議댁옱 �섏� �딆쓣 寃쎌슦 遺�え �몃뱶 吏�썙以�
	...
	// 
	// [IE] �몄슜援��덉뿉��湲�㉧由�湲고샇瑜��곸슜�덉쓣 �� �몄슜援�諛뽰뿉 �곸슜��踰덊샇留ㅺ린湲�湲�㉧由�湲고샇媛��몄슜援��덉쑝濡�鍮⑤젮 �ㅼ뼱媛�뒗 臾몄젣 泥섎━
	...
	_extendBlock : function(){
		// [SMARTEDITORSUS-663] [FF] block�⑥쐞濡��뺤옣�섏뿬 Range瑜��덈줈 吏�젙�댁＜�붽쾬���먮옒 �ㅽ럺�대�濡�
		// �닿껐���꾪빐�쒕뒗 �꾩옱 �좏깮��遺�텇��Block�쇰줈 extend�섏뿬 execCommand API媛�泥섎━�����덈룄濡���
		...
		// <p><img><br/><img><br/><img></p> �����대�吏�� �쇰�留��좏깮�섎㈃ 諛쒖깮
		// - container �몃뱶��P �닿퀬 container �몃뱶���먯떇�몃뱶 以��대�吏�� �щ윭媛쒖씤���좏깮���대�吏�� 洹�以��쇰���寃쎌슦
...
nhn.husky.SE2M_FontColor = jindo.$Class({
	...
	$ON_APPLY_FONTCOLOR : function(sFontColor){
		...
		// [SMARTEDITORSUS-907] 紐⑤뱺 釉뚮씪�곗��먯꽌 SET_WYSIWYG_STYLE濡��됱긽���ㅼ젙�섎룄濡�蹂�꼍
		// var oAgent = jindo.$Agent().navigator();
...
nhn.husky.SE2M_FontNameWithLayerUI = jindo.$Class({
	...
	addAllFonts : function(){
		...
		// [SMARTEDITORSUS-245] �쒕퉬���곸슜 ��湲�섦�뺣낫瑜��섍린吏��딆쑝硫�湲곕낯 湲�섦 紐⑸줉��蹂댁씠吏��딅뒗 �ㅻ쪟
		if(!this.htOptions || !this.htOptions.aDefaultFontList || this.htOptions.aDefaultFontList.length === 0){
			this.addFont("�뗭�,Dotum", "�뗭�", 0, "", "", 1);
			this.addFont("�뗭�泥�DotumChe", "�뗭�泥�", 0, "", "", 1);
			this.addFont("援대┝,Gulim", "援대┝", 0, "", "", 1);
			this.addFont("援대┝泥�GulimChe", "援대┝泥�", 0, "", "", 1);
			this.addFont("諛뷀깢,Batang", "諛뷀깢", 0, "", "", 1);
			this.addFont("諛뷀깢泥�BatangChe", "諛뷀깢泥�", 0, "", "", 1);
			this.addFont("沅곸꽌,Gungsuh", "沅곸꽌", 0, "", "", 1);
	...
	$ON_SET_FONTFAMILY : function(sFontFamily, sDefaultSize){
		...
		// fontFamily��fontSize �먭컻���≪뀡���섎굹濡�臾띠뼱��undo history ��옣
...
*/		
		...
		//
		// 		�ㅻ쭏�몄뿉�뷀꽣��寃쎌슦, �뱁룿�몃� �좏깮���뚮쭏��SPAN ���덈줈 異붽��섎뒗 寃껋씠 �꾨땶 �좏깮��SPAN ��fontFamily 瑜�蹂�꼍�섏뿬 泥섎━�섎�濡�
		// 		fontFamily 蹂�꼍 ��DOM Tree �곸뿉���붿씠���ъ슜�섏� �딅뒗 寃껋쑝濡�釉뚮씪�곗� �먮떒�섏뿬 �몃줈���대쾭由�
		// [�닿껐] 
		//		�몃줈�쒓� 諛쒖깮�섏� �딅룄濡�硫붾돱 由ъ뒪�몄뿉 �ㅽ��쇱쓣 �곸슜�섎뒗 寃껋쓣 @font-face �댄썑濡��섎룄濡�泥섎━�섏뿬 DOM Tree �곸뿉 ��긽 �곸슜�����덈룄濡���
		//
		// [SMARTEDITORSUS-969] [IE10] �뱁룿�몃� �ъ슜�섏뿬 湲�쓣 �깅줉�섍퀬, �섏젙紐⑤뱶濡��ㅼ뼱媛붿쓣 ���뱁룿�멸� �곸슜�섏� �딅뒗 臾몄젣
...
function fontProperty(fontId, fontName, defaultSize, fontURL, fontCSSURL){
	...
	if(this.fontCSSURL != ""){
		...
		// �대떦 �고듃����븳 �몃줈��臾몄젣媛�怨꾩냽 諛쒖깮�섏뿬 IE9�먯꽌 addFont �먯꽌 �몄텧�섎뒗 loadCSS ��寃쎌슦�먮뒗 isLoaded瑜�true 濡�蹂�꼍�섏� �딆쓬.
...
nhn.husky.SE2M_Hyperlink = jindo.$Class({
	...
	$ON_APPLY_HYPERLINK : function(){
		...
		if(this._validateURL(sURL)){
			...
			if(this.oSelection.collapsed){
				...
				// 釉뚮씪�곗��먯꽌 �쒓났�섎뒗 execcommand��createLink濡쒕뒗 ��쿊��吏�젙���섍� �녿떎.
				// 洹몃젃湲��뚮Ц�� �붾� URL��createLink���섍꺼��留곹겕瑜�癒쇱� 嫄멸퀬, �댄썑��loop���뚮㈃���붾� URL��媛�쭊 A�쒓렇瑜�李얠븘���뺤긽 URL 諛���쿊���명똿 ��以�떎.
				sBM = this.oSelection.placeStringBookmark();
				this.oSelection.select();
				
				// [SMARTEDITORSUS-61] TD �덉뿉 �덈뒗 �띿뒪�몃� �꾩껜 �좏깮�섏뿬 URL 蹂�꼍�섎㈃ �섏젙�섏� �딆쓬 (only IE8)
				//		SE_EditingArea_WYSIWYG �먯꽌��IE��寃쎌슦, beforedeactivate �대깽�멸� 諛쒖깮�섎㈃ �꾩옱��Range瑜���옣�섍퀬, RESTORE_IE_SELECTION 硫붿떆吏�� 諛쒖깮�섎㈃ ��옣��Range瑜��곸슜�쒕떎.
				//		IE8 �먮뒗 IE7 �명솚紐⑤뱶�닿퀬 TD �덉쓽 �띿뒪���꾩껜瑜��좏깮��寃쎌슦  Bookmark �앹꽦 �꾩쓽 select()瑜�泥섎━����
				//		HuskyRange �먯꽌 �몄텧�섎뒗 this._oSelection.empty(); �먯꽌 beforedeactivate 媛�諛쒖깮�섏뿬 empty 泥섎━��selection ����옣�섎뒗 臾몄젣媛��덉뼱 留곹겕媛��곸슜�섏� �딆쓬.
				//		�щ컮瑜�selection ����옣�섏뼱 EXECCOMMAND�먯꽌 留곹겕媛��곸슜�����덈룄濡���
	...
	irToDb : function(oTmpNode){
		//��옣 �쒖젏���먮룞 留곹겕瑜��꾪븳 �⑥닔.
		//[SMARTEDITORSUS-1207][IE][硫붿씪] object �쎌엯 ��湲�쓣 ��옣�섎㈃ IE 釉뚮씪�곗�媛�二쎌뼱踰꾨━���꾩긽   
		//�먯씤 : �뺤씤 遺덇�. IE ��옉沅�愿�젴 �댁뒋濡�異붿젙
		//�닿껐 : contents瑜�媛��怨��덈뒗 div �쒓렇瑜����⑥닔 �대��먯꽌 蹂듭궗�섏뿬 �섏젙 ��call by reference濡��섏뼱��蹂�닔��innerHTML��蹂�꼍	
		...
		/*
		// �띿뒪��寃�깋���⑹씠 �섎룄濡��딆뼱吏��띿뒪���몃뱶媛��덉쑝硫��⑹퀜以� (�붾㈃�곸쑝濡�ABC�쇨퀬 蹂댁씠���곹솴���곕씪 �ㅼ젣 2媛쒖쓽 �띿뒪��A, BC濡��대（�댁졇 �덉쓣 ���덉쓬. �대� ABC �섎굹���몃뱶濡�留뚮뱾��以�)
		// 臾몄젣 諛쒖깮 媛�뒫�깆뿉 鍮꾪빐���쇳룷癒쇱뒪���ъ씠���댄럺��媛�뒫���믪븘 �쇰떒 二쇱꽍
		var aCleanTextNodes = [];
		...
		*/
		...
		// IE�먯꽌 PRE瑜��쒖쇅���ㅻⅨ �쒓렇 �섏쐞���덈뒗 �띿뒪���몃뱶��以꾨컮轅��깆쓽 媛믪쓣 蹂�쭏�쒗궡
		...
		for(var i=0, nLen=aAllTextNodes.length; i<nLen; i++){
			...
			// IE�먯꽌 �띿뒪���몃뱶 �욎そ���ㅽ럹�댁뒪��二쇱꽍�깆씠 �щ씪吏�뒗 �꾩긽���덉뼱 sTmpStr���욎뿉 遺숈뿬以�
			elTmpDiv.innerHTML = "";
			...
			try {
				...
				// innerHTML �댁뿉 �띿뒪�멸� �덉쓣 寃쎌슦 insert �쒖뿉 二쇰� �띿뒪���몃뱶���⑹퀜吏�뒗 �꾩긽���덉뼱 div濡��꾩튂瑜�癒쇱� �↔퀬 �섎굹���쎌엯
...
nhn.husky.SE_WYSIWYGStyleGetter = jindo.$Class({
	...
	_getStyleOf : function(oNode){
		...
		// IE�먯꽌��湲곕낯 �뺣젹��queryCommandState濡��섏뼱�ㅼ� �딆븘���뺣젹���녿떎硫� �쇱そ �뺣젹濡�媛�젙��
...
nhn.husky.SE_WYSIWYGStyler = jindo.$Class({
	...
	$ON_SET_WYSIWYG_STYLE : function(oStyles){
		...
		if(oSelection.collapsed && !bSelectedBlock){
			...
			this._addCursorHolder(oSelection, oSpan);	// [SMARTEDITORSUS-178] [IE9] 而ㅼ꽌媛��꾨줈 �щ씪媛�뒗 臾몄젣
...
*/
			...
			// [SMARTEDITORSUS-416] 而ㅼ꽌媛��щ씪媛�� �딅룄濡�BR ���대젮��
			// if(jindo.$Agent().navigator().firefox){
				// oSpan.innerHTML = "";
			// }
			return;
...
nhn.husky.SE2M_Quote = jindo.$Class({
	...
	/**
	 * �몄슜援ъ쓽 以묒꺽 媛�뒫��理쒕� 媛쒖닔瑜��섏뿀�붿� �뺤씤��
	 * �몄슜援��대��먯꽌 �몄슜援щ� �곸슜�섎㈃ 以묒꺽�섏� �딆쑝誘�줈 �먯떇�몃뱶����빐�쒕쭔 �뺤씤��	 */
...
//		var sBookmarkID = oSelection.placeStringBookmark();
		...
		// [SMARTEDITORSUS-430] 臾몄옄瑜��낅젰�섍퀬 Enter ���몄슜援щ� �곸슜�����꾩쓽 臾몄옄�ㅼ씠 �몄슜援��덉뿉 �ㅼ뼱媛�뒗 臾몄젣
		...
		oNode = oStartNode;
		// IE�먯꽌��commonAncestorContainer �먯껜��select 媛�뒫�섏� �딄퀬, �섏쐞��commonAncestorContainer瑜���껜 �섎뜑�쇰룄 �묎컳���곸뿭����젆���섏뼱 蹂댁씠��
		...
		setTimeout(jindo.$Fn(function(oSelection){
			...
			this.oApp.exec("FOCUS");	// [SMARTEDITORSUS-469] [SMARTEDITORSUS-434] �먮뵒��濡쒕뱶 ��理쒖큹 �쎌엯���몄슜援��덉뿉 �ъ빱�ㅺ� 媛�� �딅뒗 臾몄젣
...
nhn.husky.SE2M_TableBlockStyler = jindo.$Class({
	...
	setTdBlock : function() {
		this.oApp.exec("GET_SELECTED_CELLS",['aTdCells',this.htSelectedTD]); //tableEditor濡�遺�꽣 �살뼱�⑤떎.
...
nhn.husky.SE2M_TableCreator = jindo.$Class({
	...
	// [SMARTEDITORSUS-365] �뚯씠釉뷀��먮뵒��> �띿꽦 吏곸젒�낅젰 > �뚮몢由��ㅽ���
	//		- �뚮몢由��놁쓬���좏깮�섎뒗 寃쎌슦 蹂몃Ц���쎌엯�섎뒗 �쒖뿉 媛�씠���쇱씤���쒖떆��以띾땲�� 蹂닿린 �쒖뿉���뚮몢由ш� 蹂댁씠吏��딆뒿�덈떎.
	$ON_REGISTER_CONVERTERS : function(){
	...
	irToDbDOM : function(oTmpNode){
		...
		// [SMARTEDITORSUS-410] 湲���옣 �� �뚮몢由��놁쓬 �띿꽦���좏깮�����꾩쓽濡��쒖떆��媛�씠���쇱씤 property 留�style �먯꽌 �쒓굅��以�떎.
		// <TABLE> 怨�<TD> ���띿꽦媛믪쓣 蹂�꼍 諛��쒓굅
		var aTDs = [], oTable;
		for(var i = 0, nCount = aNoBorderTable.length; i < nCount; i++){
			oTable = aNoBorderTable[i];
			
			// <TABLE> �먯꽌 border, cellpadding �띿꽦媛�蹂�꼍, style property �쒓굅
	...
	dbToIrDOM : function(oTmpNode){
		...
		// <TABLE> 怨�<TD> ���띿꽦媛믪쓣 蹂�꼍/異붽�
		var aTDs = [], oTable;
		for(var i = 0, nCount = aNoBorderTable.length; i < nCount; i++){
			oTable = aNoBorderTable[i];
			
			// <TABLE> �먯꽌 border, cellpadding �띿꽦媛�蹂�꼍/ style �띿꽦 異붽�
...
//		this.oSelection = this.oApp.getSelection();
	...
	$ON_TABLE_INSERT : function(){
		...
		//max �쒗븳���곸슜���덈릺湲��뚮Ц���뚯씠釉��ъ엯 �쒖젏���ㅼ떆�쒕쾲 Max 媛믪쓣 寃�궗�쒕떎.
	 ...
	 *		�뚯씠釉붿씠 異붽��섎뒗 遺�텇��P 媛��덈뒗 寃쎌슦, P 瑜�遺꾨━�쒖폒二쇰뒗 泥섎━
	 */
	_divideParagraph : function(oSelection){
		...
		if(!oParentP.firstChild || nhn.husky.SE2M_Utils.isBlankNode(oParentP)){
			oSelection.selectNode(oParentP);	// [SMARTEDITORSUS-423] 遺덊븘�뷀븳 媛쒗뻾���쇱뼱�섏� �딅룄濡�鍮�P 瑜��좏깮�섏뿬 TABLE 濡���껜�섎룄濡�泥섎━
			oSelection.select();
	...
	_doGetTableString : function(nColumns, nRows, nBorderSize, sBorderColor, sBGColor, nBorderStyleIdx){
		...
		// [SMARTEDITORSUS-365] �뚯씠釉뷀��먮뵒��> �띿꽦 吏곸젒�낅젰 > �뚮몢由��ㅽ���
		//		- �뚮몢由��놁쓬���좏깮�섎뒗 寃쎌슦 蹂몃Ц���쎌엯�섎뒗 �쒖뿉 媛�씠���쇱씤���쒖떆��以띾땲�� 蹂닿린 �쒖뿉���뚮몢由ш� 蹂댁씠吏��딆뒿�덈떎.
		//		- 湲���옣 �쒖뿉��湲��묒꽦 �쒖뿉 �곸슜�섏���style ���쒓굅�⑸땲�� �대� �꾪빐���꾩쓽���띿꽦(attr_no_border_tbl)��異붽��섏��ㅺ� ��옣 �쒖젏�먯꽌 �쒓굅��二쇰룄濡��⑸땲��
...
//		this.oApp.registerBrowserEvent(this.elPanelReviewBtnArea, "click", "SAVE_QE_MY_REVIEW_ITEM"); //My由щ럭 踰꾪듉 �덉씠��
	...
	// [Undo/Redo] Table Selection 泥섎━��愿�젴��遺�텇 二쇱꽍 泥섎━
	...
	$ON_SETUP_TABLE_QE_MODE : function(nMode){
		...
		//null�멸꼍�곕� ��퉬�댁꽌 default媛믪쓣 吏�젙�댁���
...
//top.document.title = this.htSelectionSPos.x+","+this.htSelectionSPos.y+"::"+this.htSelectionEPos.x+","+this.htSelectionEPos.y;
	...
	// ���좏깮 �곹깭�먯꽌 臾몄꽌�곸뿭�����섎줈 踰쀬뼱��寃쎌슦, 踰쀬뼱��諛⑺뼢�쇰줈 �좏깮 ��쓣 �섎젮媛�ŉ 臾몄꽌���ㅽ겕濡ㅼ쓣 �댁쨲
...
//			jindo.$Element(aCellInfo[0]).css("height", aCellInfo[2]);
	...
	_showCellResizeGrip : function(){
		...
		if(this.htResizing.nResizeMode == 1){
			...
			//媛����쓣 吏�썝�섍린 �뚮Ц��留ㅻ쾲 �꾩옱 Container���ш린瑜�援ы빐��꽌 Grip���앹꽦�댁빞 �쒕떎.
	...
	_getAllAffectedCells : function(basis_x, basis_y, iResizeMode, oTable){
		...
		if(iResizeMode == 1){
			...
			// �믪씠 由ъ궗�댁쭠 �쒖뿉���좏깮 �뚮몢由��욎そ ��쭔 議곗젅 �⑥쑝濡��꾨옒履���� �앹꽦 ���꾩슂 �놁쓬
...
*/
		...
		// remove empty TR's
		// (�곷떒 TD��rowspan留뚯쑝濡�吏�꺊�섎뒗) 鍮�TR���덉쓣 寃쎌슦 IE7 �댄븯�먯꽌 �쒕뜑留��ㅻ쪟媛�諛쒖깮 �����덉뼱 鍮�TR��吏�썙 以�
...
nhn.husky.SE2M_QuickEditor_Common = jindo.$Class({
	...
	/**
	 * �꾩����곸뿭���⑥텞�ㅺ� �깅줉���� 
	 * tab 怨�shift+tab (�ㅼ뿬�곌린 / �댁뼱�곌린 ) 瑜��쒖쇅���⑥텞��由ъ뒪�몃� ��옣�쒕떎.
	 */
	 ...
	 * �덉씠�닿� �ㅽ뵂 �����ㅽ뻾�섎뒗 �대깽��
	 * �덉씠�닿� 泥섏쓬 ����
	 * 		��옣���⑥텞��由ъ뒪�몃� �덉씠�댁뿉 �깅줉�섍퀬 (�덉씠�닿� ���덉쓣�뚮룄 �⑥텞�ㅺ� 癒밸룄濡��섍린 �꾪빐)
	 * 		�덉씠�댁뿉 ��븳 �ㅻ낫��留덉슦���대깽�몃� �깅줉�쒕떎.
	 * @param {Element} oEle
...
*/
	...
	/**
	 * �덉씠�댁쓽 �꾩튂瑜�諛섑솚 �섎뒗 �⑥닔
	 *		怨좎젙 �곹깭媛��꾨땲嫄곕굹 理쒖냼���곹깭�대㈃ �섎━癒쇳듃 �꾩튂���듭뿉�뷀꽣瑜��꾩슦怨�	 *		怨좎젙 �곹깭�닿퀬 理쒕����곹깭�대㈃ �쒕굹 湲��묒떇����옣���꾩튂���꾩썙二쇨퀬, �대�吏�뒗...?
	 * @param {Element} oEle
	 * @param {Element} oLayer
	 */
...
---------------------------------------------------------------------------]*/
/**
 * @pluginDesc �쒕쾲���쒓컻留��붾㈃��蹂댁뿬���섎뒗 �덉씠�대� 愿�━�섎뒗 �뚮윭洹몄씤
 */
...
---------------------------------------------------------------------------]*/
/**
 * @pluginDesc �쒕옒洹멸� 媛�뒫���덉씠�대� 而⑦듃濡��섎뒗 �뚮윭洹몄씤
 */
 ...
 * 	// 媛��뚮윭洹몄씤 �앹뾽�섏씠吏�뿉���대떦 硫붿떆吏�� �곗씠��� �섍린寃���
 * 	this.@ON_NEWPLUGIN_WINDOW_CALLBACK = function(){
 * 		// �앹뾽�섏씠吏�퀎濡��뺤쓽���뺥깭���꾧퇋癒쇳듃 �곗씠��� �섏뼱�ㅻ㈃ 泥섎━�쒕떎.
 * 	}
 * }
 ...
 * @public
 * @param {Object} oOpenWin �앹뾽 �섏씠吏�쓽 window 媛앹껜
 * @param {Object} sMsg	�뚮윭洹몄씤 硫붿떆吏�챸
...
nhn.husky.SE2M_ImgSizeRatioKeeper = jindo.$Class({
	...
	_onResizeEnd : function(wev){
		...
		// [SMARTEDITORSUS-299] 留덉슦��Drag濡��대�吏��ш린 由ъ궗�댁쫰 �� �쎌엯���뚯쓽 ��옣 �ъ씠利�rwidth/rheight)��蹂�꼍��以�
		...
		// �꾨옒��遺�텇��異뷀썑 hp_SE2M_ImgSizeAdjustUtil.js 瑜��앹꽦�섏뿬 遺꾨━�쒕떎.
	...
	_isAdjustPossible : function(width){
		...
		// 媛�줈���곸슜�섎뒗 寃쎌슦�먮쭔 �먮뵒��蹂몃Ц �덉뿉 蹂댁씠���대�吏��ъ씠利덈� 議곗젅��
...
nhn.husky.SE2M_Utils = {
	...
	/**
	 * HashTable濡�援ъ꽦��Array��媛숈� �꾨줈�쇳떚瑜�sSeperator 濡�援щ텇��String 媛믪쑝濡�蹂�솚
	 * @param {Object} v
	 * @param {Object} sKey
	 * @author senxation
	 * @example 
...
ellipsis(jindo.$("a"), jindo.$("a").parentNode, "...", 2);
	...
	ellipsis : function(elText, elContainer, sStringTail, nLine) {
		...
		/**
		 * 吏�젙���쇱씤蹂대떎 而ㅼ쭏�뚭퉴吏��꾩껜 �⑥� 臾몄옄�댁쓽 �덈컲���뷀빐�섍컧
		 */
	...
	/**
	 * 理쒕� 媛�줈�ъ씠利덈� 吏�젙�섏뿬 留먯쨪�꾪븳��
	 * elText��css white-space媛믪씠 "nowrap"�댁뼱�쇳븳�� (而⑦뀒�대꼫蹂대떎 �띿뒪�멸� 湲몃㈃ �됰��섎릺吏�븡怨�媛�줈濡�湲멸쾶 �쒗쁽�섎뒗 �곹깭)
	 * @param {HTMLElement} elText 留먯쨪�꾪븷 �섎━癒쇳듃
	 * @param {String} sStringTail 留먯쨪�꾩쓣 �쒗쁽��臾몄옄��(誘몄��뺤떆 ...)
...
ellipsisByPixel(jindo.$("a"), "...", 150);
	...
	/**
	 * �щ윭媛쒖쓽 �섎━癒쇳듃瑜�媛곴컖��吏�젙��理쒕��덈퉬濡�留먯쨪�꾪븳��
	 * 留먯쨪�꾪븷 �섎━癒쇳듃��css white-space媛믪씠 "nowrap"�댁뼱�쇳븳�� (而⑦뀒�대꼫蹂대떎 �띿뒪�멸� 湲몃㈃ �됰��섎릺吏�븡怨�媛�줈濡�湲멸쾶 �쒗쁽�섎뒗 �곹깭)
	 * @param {Array} aElement 留먯쨪�꾪븷 �섎━癒쇳듃��諛곗뿴. 吏�젙���쒖꽌��줈 留먯쨪�꾪븳��
	 * @param {String} sStringTail 留먯쨪�꾩쓣 �쒗쁽��臾몄옄��(誘몄��뺤떆 ...)
...
paddingZero(10, 5); ==> "00010" (String)
	...
	/**
	 * Hash Table�먯꽌 �먰븯���ㅺ컪留뚯쓣 媛�����꾪꽣���덈줈��Hash Table��援ы븳�� 
...
==> { a : 1, c : 3 }
	 ...
	 * @param {String} sTagName 寃�깋 ���쒓렇紐�
	 * @param {HTMLElement} elNode 寃�깋 �쒖옉�먯쑝濡��ъ슜 ���몃뱶
	 * @return {HTMLElement} 遺�え �몃뱶 以��쒓렇紐낆씠 sTagName怨��쇱튂�섎뒗 �몃뱶. �놁쓣 寃쎌슦 null 諛섑솚 
	 */
	...
	/**
	 * iframe �곸뿭��aling �뺣낫瑜��ㅼ떆 �명똿�섎뒗 遺�텇.
	 ...
	 */
	// [COM-1151] SE2M_PreStringConverter �먯꽌 �섏젙�섎룄濡�蹂�꼍
	...
	/**
	 * jindo.$JSON.fromXML��蹂�솚��硫붿꽌��
	 * �뚯닽�먯씠 �덈뒗 寃쎌슦��泥섎━ �쒖뿉 �レ옄濡�蹂�솚�섏� �딅룄濡���parseFloat �ъ슜 �덊븯�꾨줉 �섏젙)
	 * 愿�젴 BTS : [COM-1093]
 ...
 * 	HTML紐⑤뱶��TEXT 紐⑤뱶���몄쭛 �곸뿭��TEXTAREA����븳 �먮룞�뺤옣 泥섎━
 */
...
/**
 * 臾몄옄瑜��곌껐�섎뒗 '+' ��떊��java���좎궗�섍쾶 泥섎━�섎룄濡�臾몄옄��泥섎━�섎룄濡�留뚮뱶��object
 * @author nox
 * @example
...
---------------------------------------------------------------------------]*/
/**
 * @pluginDesc Husky Framework�먯꽌 �먯＜ �ъ슜�섎뒗 �좏떥��硫붿떆吏�� 泥섎━�섎뒗 �뚮윭洹몄씤
 */
 ...
 * @description 硫붿씪 �꾩슜 而ㅼ뒪�곕쭏�댁쫰 �대컮濡��붾낫湲��덉씠��愿�━留뚯쓣 �대떦�섍퀬 �덉쓬.
 * @class
...
nhn.husky.SE2B_Customize_ToolBar = jindo.$Class(/** @lends nhn.husky.SE2B_Customize_ToolBar */{
	...
	/**
	 * @constructs
	 * @param {Object} oAppContainer �먮뵒�곕� 援ъ꽦�섎뒗 而⑦뀒�대꼫
	 */
	$init : function(oAppContainer) {
		this._assignHTMLElements(oAppContainer);
	},
	...
	/**
	 * @private
	 * @description DOM�섎━癒쇳듃瑜��섏쭛�섎뒗 硫붿냼��	 * @param {Object} oAppContainer �대컮 �ы븿 �먮뵒�곕� 媛먯떥怨��덈뒗 div �섎━癒쇳듃
	 */
	_assignHTMLElements : function(oAppContainer) {
	...
	/**
	 * CHANGE_EDITING_MODE紐⑤뱶 �댄썑���몄텧�섏뼱���� 
	 * WYSIWYG 紐⑤뱶媛��쒖꽦�붾릺湲��꾩뿉 �몄텧���섎㈃ APPLY_FONTCOLOR�먯꽌 �먮윭 諛쒖깮.
	 */
	$ON_RESET_TOOLBAR : function(){
		...
		//�대┛ �앹뾽���リ린 �꾪빐��		this.oApp.exec("DISABLE_ALL_UI");
		this.oApp.exec("ENABLE_ALL_UI");
		//湲�옄�됯낵 湲�옄 諛곌꼍�됱쓣 �쒖쇅���명똿
		this.oApp.exec("RESET_STYLE_STATUS");
		this.oApp.exec("CHECK_STYLE_CHANGE");
		//理쒓렐 �ъ슜��湲�옄���뗮똿.
 ...
 */
var oMessageMap = {
	'SE_EditingAreaManager.onExit' : '�댁슜��蹂�꼍�섏뿀�듬땲��',
	...
	'SE_FindReplace.replaceAllResultP2' : '嫄�諛붾��덉뒿�덈떎.',
	...
	'SE2M_EditingModeChanger.confirmTextMode' : '�띿뒪��紐⑤뱶濡��꾪솚�섎㈃ �묒꽦���댁슜���좎��섎굹, \n\n湲�섦 �깆쓽 �몄쭛�④낵���대�吏��깆쓽 泥⑤��댁슜��紐⑤몢 �щ씪吏�쾶 �⑸땲��\n\n�꾪솚�섏떆寃좎뒿�덇퉴?',
	'SE2M_FontNameWithLayerUI.sSampleText' : '媛�굹�ㅻ씪'
};
